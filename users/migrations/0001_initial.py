# Generated by Django 6.0.5 on 2026-07-02 10:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('patient', 'Пациент'), ('doctor', 'Врач'), ('clinic', 'Клиника'), ('admin', 'Администратор')], default='patient', max_length=10)),
        ...
        migrations.AddField(
            ...
            name='clinic',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='branches', to='users.clinicprofile'),
        ),
        migrations.CreateModel(
            name='DoctorProfile',
            fields=[
                ...
                ('patient_conditions', models.JSONField(blank=True, default=list, null=True)),
                ...
                ('services', models.ManyToManyField(blank=True, related_name='doctors', to='services.service')),
