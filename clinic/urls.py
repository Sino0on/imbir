...
from .views import (
    ...
    DoctorInvitationListCreateView,
    DoctorInvitationDeleteView,
...
urlpatterns = [
    ...
    path('doctor-invitations/', DoctorInvitationListCreateView.as_view(), name='clinic-doctor-invitation-list-create'),
    path('doctor-invitations/<int:pk>/', DoctorInvitationDeleteView.as_view(), name='clinic-doctor-invitation-delete'),
